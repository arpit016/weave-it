...
The skill should not behave like Fab's `fab-continue`. Weave's model is artifact-first rather than pipeline-runner-first. Users should resume work by invoking the artifact lane skill directly:
