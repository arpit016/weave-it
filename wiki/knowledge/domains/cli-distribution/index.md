...
- **Skill contract block**: a byte-identical prose section embedded in every shipped `SKILL.md`. Currently three: `# Surface Weave Notices` (all 10 skills), `# Plan Mode Protocol` (4 design-discussion skills), `# Lifecycle Staleness Verification` (5 progress-calling skills).
